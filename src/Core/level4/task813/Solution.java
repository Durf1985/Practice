...
public class Solution {
    ...
    public static boolean isWork(CompItem item) { // здесь мы присваиваем переменной типа интерфейс объект, который реализует этот интерфейс.
